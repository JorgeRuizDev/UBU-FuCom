	...
	;
	;	1.1: Ahora se intercambian los valores de la 1202h y 1203h
	;
	;
	;------------------------------------------------------------------------------------------------------
	;
	...
	;				Fin de ejecución: Resultado
	;
	;	1203H:		Almacenamiento temporal del resultado
	;				Fin de ejecución: Estado final del desplazamiento del operando 2
	;	
